...
a persistence unit "cursos-online-dockerPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "cursos-online-docker/pom.xml":
...
artifact ("cursos-online-docker.war") is already built. You can build
